import { useState, useEffect, useMemo, cloneElement, createElement, Fragment } from 'react';
...
var domtoimage = require('./lib/dom-to-image');
var MakeDomImage = function (_a) {
    ...
    var Button = useMemo(function () {
        return cloneElement(trigger, { onClick: onClickEvent });
    }, [trigger]);
    return createElement(Fragment, null, Button);
};
...
export { MakeDomImage, a };
//# sourceMappingURL=react-make-dom-image.es.js.map
